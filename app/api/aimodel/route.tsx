...
const openai: OpenAIType = new OpenAI({
    ...
    defaultHeaders: {
        'HTTP-Referer': 'https://trip-planners.vercel.app/', // Optional. Site URL for rankings on openrouter.ai.
        'X-Title': 'Trip Planner', // Optional. Site title for rankings on openrouter.ai.
    },
});
